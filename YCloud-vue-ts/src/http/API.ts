...
// const SERVER_BASE:string = window.localStorage.getItem(API_PATH) || "http://127.0.0.1:8080";   // 服务器地址
window.localStorage.setItem("API_PATH", "http://localhost:8080")
const SERVER_BASE:string = window.localStorage.getItem(API_PATH) || "https://cloud.xiaosm.cn";   // 服务器地址
// if (window.localStorage.getItem("API_PATH")) { window.localStorage.setItem(API_PATH, null) }
...
const SERVER_DOWNLOAD:string = SERVER_API + "/resource/download";   // 下载地址
...
export { SERVER_BASE, SERVER_UPLOAD, SERVER_DOWNLOAD, SERVER_PRE_DOWNLOAD, EXCEL_EXPORT }
